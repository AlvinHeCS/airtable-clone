...
export default function BaseSideBar() {
    return (
        <div style={{height: "100vh", width: "60px", borderRight: "solid #E4E4E4 0.5px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", paddingLeft: "10px", paddingRight: "10px", paddingBottom: "20px", paddingTop: "20px", position: "sticky", top: "0"}}>
