...
export default function ShowHideColModal(showHideColModalProp: prop) {
    ...
    return(
        <div ref={modalRef} style={{boxShadow: "0 8px 12px rgba(0, 0, 0, 0.1)", zIndex: "1000", left: `${showHideColModalProp.position.left - 200}px`, top: `${showHideColModalProp.position.top + 40}px`, width: "300px", background: "white", padding: "10px", position: "fixed", gap: "10px", display: "flex", flexDirection: "column"}}>
