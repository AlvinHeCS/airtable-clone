...
export default function BaseHeader() {
    return (
        <div style={{width: "100%", height: "60px", position: "sticky", top: "0", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "solid #E4E4E4 0.5px", padding: "10px", background: "white"}}>
            ...
            <div style={{display: "flex", alignItems: "center", gap: "15px"}}>
                ...
                <button style={{borderRadius: "5px", paddingRight: "10px", padding: "5px", fontSize: "13px", width: "80px", height: "30px", border: "solid #e4e4e4e4 0.5px", display: "flex", alignItems: "center", justifyContent: "center", gap: "5px"}}>
