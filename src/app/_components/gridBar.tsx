...
export default function GridBar(GridBarProp: prop) {
    ...
    return (
        <div style={{borderTop: "#E4E4E4 solid 0.5px", borderRight: "#E4E4E4 solid 0.5px", height: "100%", width: "280px", padding: "10px", position: "sticky", top: "0", background: "rgba(255, 255, 255, 1)", display: "flex", flexDirection: "column"}}>
